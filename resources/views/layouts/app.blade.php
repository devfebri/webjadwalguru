        ...
        <nav class="navbar navbar-expand-md ">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    <h3 style="font-weight: bold;color: #fff;">SMP N 19 Kota Jambi</h3>
        ...
        <footer>
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-6 text-right">Made with <span class="bi bi-heart"></span> by <a href="https://saugi.me">Nissa hasanah siagian</a></div>
                </div>
            </div>
        </footer>
    </div>
