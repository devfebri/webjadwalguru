            ...
            <div class="d-flex justify-content-between align-items-center">
                <div class="logo">
                    <a href="{{ route('admin.dashboard') }}">
                        <h5 style="font-weight: bold;color: #ff00b6;">SMP N 19 <br> Kota Jambi</h5>
                    </a>
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                @if (Auth::user()->role != 'guru')
                    <li class="sidebar-item  {{ 'admin.dashboard' === Route::currentRouteName() ? 'active' : '' }} ">
                    ...
                    <li
                        class="sidebar-item  {{ 'admin.students.index' === Route::currentRouteName() ? 'active' : '' }} ">
                    ...
                    <li
                        class="sidebar-item  {{ 'admin.guru.index' === Route::currentRouteName() ? 'active' : '' }} ">
                    ...
                    <li
                        class="sidebar-item  {{ 'admin.kelas.index' === Route::currentRouteName() ? 'active' : '' }} ">
                ...
                @if (Auth::user()->role != 'guru')
                    <li
                        class="sidebar-item  {{ 'admin.pickets.index' === Route::currentRouteName() ? 'active' : '' }} ">
                        <a href="{{ route('admin.pickets.index') }}" class="sidebar-link ">
                            <i class="bi bi-speedometer"></i>
                            <span>Jadwal Piket </span>
                        </a>
                    </li>
                    <li
                        class="sidebar-item  {{ 'admin.articles.index' === Route::currentRouteName() ? 'active' : '' }} ">
