                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-2 ml-auto">
                                <a class="btn btn-primary float-right"
                                    href="{{ route('admin.schedules.create') }}">Tambah</a>
                            </div>
                                            ...
                                            <td>{{ $schedule->end_time }}</td>
                                                ...
                                                <td>
                                                    <div class='d-inline-flex'>
                                                        <a href="{{ route('admin.schedules.edit', ['schedule' => $schedule->id]) }}"
                                                        ...
                                                        <form
                                                            ...
                                                            @csrf
                                                            @method('delete')
                                                            <button type="submit" onclick="return confirm('Apakah anda yakin data ini ingin di hapus ?');" class='btn btn-danger btn-delete'><i
