                                                            ...
                                                            <td>
                                                                <div class='d-inline-flex'>
                                                                    ...
                                                                    <form action="{{ route('admin.subjects.destroy', ['subject' => $subject->id]) }}" method="post">
                                                                        @csrf
                                                                        @method('delete')
                                                                        <button type="submit" onclick="return confirm('Seluruh data yang berkaitan dengan mata pelajaran ini akan ikut terhapus, apa anda yakin ?');" class='btn btn-danger btn-delete'><i class="bi bi-trash"></i></button>
