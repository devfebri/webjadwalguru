                                                ...
                                                <tbody>
                                                    @foreach($students as $student)
                                                        <tr>
                                                            ...
                                                            <td><img src="{{ asset('images/students/'.$student->image_name) }}" alt="" srcset="" style="width:50px"></td>
                                                            <td>{{ $student->name }}</td>
                                                            ...
                                                            <td>
                                                                <div class='d-inline-flex'>
                                                                    ...
                                                                    <form action="{{ route('admin.students.destroy', ['student' => $student->id]) }}" method="post">
                                                                        @csrf
                                                                        @method('delete')
                                                                        <button type="submit" class='btn btn-danger btn-delete' onclick="return confirm('Seluruh data yang berkaitan dengan siswa ini akan ikut terhapus, apa anda yakin ?');"><i class="bi bi-trash"></i></button>
