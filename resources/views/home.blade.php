...
@endpush
<section class="hero" style="background-image: linear-gradient(to right, rgba(255, 0, 170, 0.9), rgba(255, 0, 149, 0.9)),url({{Storage::url("images/front/".config('web_config')['HERO_BACKGROUND_IMAGE'])}})">
    <div class="container">
        <div class="row">
