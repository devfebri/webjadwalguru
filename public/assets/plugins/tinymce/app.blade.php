...
<head>
    ...
    <link rel="dns-prefetch" href="//fonts.gstatic.com">
        <link rel="shortcut icon" href="{{ URL::asset('assets/images/x.ico')}}">
...
<body>
    <div id="app">
        ...
        <footer>
            <div class="container">
                <div class="row">
                    <div class="col-6">Copyright &copy; {{ date('Y') }} SMP N 19 kota jambi </div>

                    <div class="col-6 text-right">Nissa hasanah siagian <span class="bi bi-heart"></span> by <a href="https://saugi.me">Nissa hasanah siagian</a></div>
                </div>
            </div>
        </footer>
    </div>
